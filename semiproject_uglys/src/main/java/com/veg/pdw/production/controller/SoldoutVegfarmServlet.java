...
/**
 * Servlet implementation class SoldoutVegfarmServlet
 */
@WebServlet("/vegfarm/sold/vegfarm.do")
public class SoldoutVegfarmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SoldoutVegfarmServlet() {
        super();

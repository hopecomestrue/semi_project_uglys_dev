                                            ...
                                            <div class="row gtr-uniform justify-content-center" >
                                                <div class="col-12 col-md-6"> 
                                                    <div class="form-group row"> 
                                                        ...
                                                        <div class="col-md-8"> 
                                                            <input type="text" name="demo-name" id="demo-name" class="form-control" value="" placeholder="아이디" style=" width: 40%;"/>
                                                        </div>
                                                    </div>
                                                </div><br>
                                                <div class="col-12 col-md-6"> 
                                                    <div class="form-group row"> 
                                                        ...
                                                        <div class="col-md-8"> 
                                                            <input type="password" name="demo-password" id="demo-password" class="form-control" value="" placeholder="비밀번호" style=" width: 40%;"/>
                                                        </div>
                                                    </div>
                                                </div><br>
                                                <div class="col-12 col-md-6"> 
                                                    <div class="form-group row"> 
                                                        ...
                                                        <div class="col-md-8"> 
                                                            <input type="text" name="demo-fullname" id="demo-fullname" class="form-control" value="" placeholder="이름" style=" width: 40%;"/>
                                                        </div>
                                                    </div>
                                                </div><br>
                                                <div class="col-12 col-md-6"> 
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8"> 
                                                            <input type="text" name="demo-phone" id="demo-phone" class="form-control" value="" placeholder="휴대폰번호"style=" width: 40%;" />
                                                        </div>
                                                    </div>
                                                </div><br>
                                                <div class="col-12 col-md-6"> 
                                                    <div class="form-group row"> 
                                                        ...
                                                        <div class="col-md-8"> 
                                                            <input type="email" name="demo-email" id="demo-email" class="form-control" value="" placeholder="Email"style=" width: 60%;"/>
                                                        </div>
                                                    </div>
                                                </div><br>
                                                <div class="col-12 col-md-6"> 
